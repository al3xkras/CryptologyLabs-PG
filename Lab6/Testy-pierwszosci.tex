...
\end{Verbatim}
    \begin{section}{Metoda Fermata}
        Poniższa metoda działa na podstawie Małego Twierdzenia Fermata:
        \begin{thm}
            Jeżeli $p$ jest liczbą pierwszą, to dla dowolnej liczby całkowitej $a: a p - a \mod{p} = 0$ (lub w postaci $ap - 1 \mod{p} = 1$).
        \end{thm}
        Dla danego zbioru $s = \{0,1,...,s-1\}$ algorytm liczy $t^{a-1}\mod{a}$ s razy, gdzie $t$ jest liczbą pseudolosową z przedziału $(2,a-2)$ i sprawdza czy wynik jest równy 1. Jeśli za każdym razem $t^{a-1}\mod{a} = 1$, to zgodnie z powyższym twierdzeniem $a$ jest liczbą pierwszą.
            \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{23}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{isPrime}\PY{p}{(}\PY{n}{a}\PY{p}{,}\PY{n}{s}\PY{p}{)}\PY{p}{:}
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{s}\PY{p}{)}\PY{p}{:}
        \PY{k}{if} \PY{n}{a} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{l+m+mi}{3}\PY{p}{:}
            \PY{k}{return} \PY{k+kc}{True}
        \PY{k}{else}\PY{p}{:}
            \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{(}\PY{n}{a}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
            \PY{k}{if} \PY{n+nb}{pow}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{p}{(}\PY{n}{a}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,}\PY{n}{a}\PY{p}{)} \PY{o}{!=} \PY{l+m+mi}{1}\PY{p}{:}
